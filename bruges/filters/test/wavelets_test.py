...
class WaveletTest(unittest.TestCase):
    ...
    def test_sinc(self):
        x = array([ 1.22806643e-18,  1.80372044e-04,  9.55145603e-03,  1.10970663e-02,
                   -6.03677339e-02, -1.18910356e-01,  1.46500976e-01,  7.16418959e-01,
                    9.82157437e-01,  6.19457072e-01,  1.08681547e-01, -7.43685041e-02,
                   -3.07605493e-02,  4.25998476e-03,  2.07675616e-03, -1.49373840e-19])
